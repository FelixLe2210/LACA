...
const Notification = () => {
    ...
    const oldNotifs = [
        { id: 101, user: 'User B', text: 'sent a reaction to your post!', image: 'https://images.unsplash.com/photo-1578916171728-46686eac8d58?w=600' },
        { id: 102, user: 'User C', text: 'sent a reaction to your post!', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=600' },
        { id: 103, user: 'User A', text: 'sent a reaction to your post!', image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600' }
    ];
    ...
    return (
        <div className="mobile-wrapper">
            ...
            <div className="notif-header">
                <Link to="/" className="btn-icon" style={{color: '#000', fontSize: '24px'}}>
                        ...
                        {realNotifs.map((notif) => (
                            <div className="notif-item" key={notif.id}>
                                <div className="notif-left">
                                    <div className="notif-avatar"></div> {/* Avatar xám mặc định */}
